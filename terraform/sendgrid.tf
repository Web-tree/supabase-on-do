...
#   domain = var.domain
#   type   = upper("${sendgrid_link_branding[0].this.dns[0].type}")
#   name   = trimsuffix(sendgrid_link_branding[0].this.dns[0].host, ".${var.domain}")
#   value  = upper("${sendgrid_link_branding[0].this.dns[0].type}") == "CNAME" ? "${sendgrid_link_branding[0].this.dns[0].data}." : sendgrid_link_branding[0].this.dns[0].data
#   ttl    = local.ttl[upper(sendgrid_link_branding[0].this.dns[0].type)]
# }
...
#   value  = upper("${sendgrid_link_branding[0].this.dns[1].type}") == "CNAME" ? "${sendgrid_link_branding[1].this.dns[1].data}." : sendgrid_link_branding[1].this.dns[1].data
#   ttl    = local.ttl[upper(sendgrid_link_branding[0].this.dns[1].type)]
# }
